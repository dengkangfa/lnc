...
class Smarty_Internal_Compile_Section extends Smarty_Internal_CompileBase {
    ...
    public function compile($args, $compiler)
    {
        ...
        $output .= "if ({$section_props}['show']):\n";
        $output .= "
            for ({$section_props}['Main'] = {$section_props}['start'], {$section_props}['iteration'] = 1;
                 {$section_props}['iteration'] <= {$section_props}['total'];
                 {$section_props}['Main'] += {$section_props}['step'], {$section_props}['iteration']++):\n";
        $output .= "{$section_props}['rownum'] = {$section_props}['iteration'];\n";
        $output .= "{$section_props}['index_prev'] = {$section_props}['Main'] - {$section_props}['step'];\n";
        $output .= "{$section_props}['index_next'] = {$section_props}['Main'] + {$section_props}['step'];\n";
