...
class Smarty_Internal_Compile_Foreach extends Smarty_Internal_CompileBase {
    ...
    public function compile($args, $compiler, $parameter)
    {
        ...
        if ($has_name) {
            ...
            $usesSmartyIndex = strpos($tpl->source->content, $SmartyVarName . 'Main') !== false;
        ...
        $usesPropIndex = $usesPropFirst || strpos($tpl->source->content, $ItemVarName . 'Main') !== false;
        ...
        if ($usesPropIndex) {
            $output .= " \$_smarty_tpl->tpl_vars[$item]->Main=-1;\n";
        }
        if ($usesPropShow) {
        ...
        if ($has_name) {
            ...
            if ($usesSmartyIndex) {
                $output .= " \$_smarty_tpl->tpl_vars['smarty']->value['foreach'][$name]['Main']=-1;\n";
            }
            if ($usesSmartyShow) {
        ...
        if ($usesPropIndex) {
            $output .= " \$_smarty_tpl->tpl_vars[$item]->Main++;\n";
        }
        if ($usesPropFirst) {
            $output .= " \$_smarty_tpl->tpl_vars[$item]->first = \$_smarty_tpl->tpl_vars[$item]->Main === 0;\n";
        }
        if ($usesPropLast) {
        ...
        if ($has_name) {
            ...
            if ($usesSmartyIndex) {
                $output .= " \$_smarty_tpl->tpl_vars['smarty']->value['foreach'][$name]['Main']++;\n";
            }
            if ($usesSmartyLast) {
