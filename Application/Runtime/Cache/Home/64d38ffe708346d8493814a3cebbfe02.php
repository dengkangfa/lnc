                    ...
                    <form action="<?php echo U('login');?>" method="post">
                        <div class="one">
                            <ul>
                                ...
                                <li>
                                    <input type="checkbox" name="checkbox" id="remember" value="" />
                                </li>
                                <li></li>
                            </ul>
                        </div>
...
<div class="right">
    ...
    <link rel="stylesheet" href="/lnc/Public/css/tweets.css"/>
    <!--主要内容-->
    <div id="main">
        <?php if(!empty($tweets)): if(is_array($tweets)): foreach($tweets as $key=>$vo): ?><div class="twtop">
                    ...
                    <div class="shijian">
                        <p><?php echo (date('Y-m-d',$vo["t_date"])); ?></p>
                    </div>
                    <div class="zuozhe">
                        <span>作者：</span>
...
<div class="pinglun" style="height: 40%;width: 100%;">
            ...
            <div class="liuyan">
                <?php if(!empty($comment)): if(is_array($comment)): foreach($comment as $key=>$vo): ?><div class="ly">
                            <div class="yk">
                                ...
                                <p class="commentUserName"><?php echo ($vo["u_name"]); ?></p>
                                <p class="lytime"><?php echo (date('Y-m-d',$vo["date"])); ?></p>
                            </div>
    ...
    <script type="text/javascript" src="/lnc/Public/js/tweetsWangEditor.js"></script>
