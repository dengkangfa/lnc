...
<html>
	...
	<link rel="stylesheet" type="text/css" href="/lnc/Public/css/set_head.css"/>
	<body>
		<div id="box">
			<div class="title">
				<a href="/lnc/BoardManage" id="back_btn">返回</a>
			</div>
			<div class="content">
				<div class="info">
					<!--当前头像-->
					<div class="one">
						<div class="img_container">
							<img src="img/未标题-1.jpg" id="pic"/><br />	
						</div>
						<p>当前图片</p>
