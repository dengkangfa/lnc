    ...
    <div class="out">
        ...
        <div class="btn_search">
            <ul>
                ...
                <?php if(empty($user)): ?><!--没登陆-->
                    <li id="login_btn">登陆</li>
                    <?php else: ?>
                    <!--登陆之后-->
                    <li id="user_info">
                        <!--用户名-->
                    ...
                    <form action="<?php echo U('login');?>" method="post">
                        <div class="one">
                            <ul>
                                ...
                                <li>
                                    <input type="checkbox" name="checkbox" id="remember" value="0" />
                                </li>
                                <li></li>
                            </ul>
                        </div>
                    ...
                    <div class="frame">
                        <div class="three">
                            <ul>
                                ...
                                <!--手机号-->
                                <li>
                                    <input type="text" name="u_email" id="email" value="" class="text" placeholder="填写常用邮箱"/>
                                </li>
                                <!--手机验证码-->
                                <li>
                                    <input type="text" name="" id="code" value="" class="text" placeholder="邮箱验证码"/>
                                </li>
                                <!--注册按钮-->
                                <li>
...
<!--二维码-->
<div class="right">
    <img src="/lnc/Public/img/749413009632672666.jpg"/>
    <span>扫二维码关注岭南校园公众号哟~</span>
</div>
</div>


	<link rel="stylesheet" type="text/css" href="/lnc/Public/css/plate.css"/>
<!--		中间贴吧分栏-->
            <div class="tb_middle">
                <?php if(!empty($plate_board)): if(is_array($plate_board)): foreach($plate_board as $key=>$vo): ?><a href="/lnc/Board/personal/id/<?php echo ($vo["b_id"]); ?>">
                        <div class="tb">
                            <div class="tb_touxiang">
                                <img src="<?php echo ($vo["b_headicon"]); ?>">
                            </div>
                            <div class="tb_biaoti">
                                <span class="hot"></span>
                                <span><?php echo ($vo["b_name"]); ?></span>
                            </div>
                            <div class="tb_fangwen">
                                <span class="fw_rs"></span>
                                <p><?php echo ($vo["u_count"]); ?></p>
                                <span class="fw_cs"></span>
                                <p><?php echo ($vo["p_count"]); ?></p>
                            </div>
                            <div class="tb_xianqing">
                                <p style="color: #5375ff; opacity:1;"><?php echo ($vo["b_explain"]); ?></p>
                            </div>
                        </div>
                        </a><?php endforeach; endif; ?>
                    <?php else: ?>
                    该版块下没有任何数据<?php endif; ?>
            </div>
		<!--页尾-->
		<div id="bottom">
