...
class Model {
    ...
    // 链操作方法列表
    protected $methods          =   array('strict','order','alias','having','group','lock','distinct','auto','filter','validate','result','token','Main','force');
    ...
    public function select($options=array()) {
        ...
        if(!empty($resultSet)) { // 有查询结果
            ...
            if(isset($options['Main'])){ // 对数据集进行索引
                $index  =   explode(',',$options['Main']);
