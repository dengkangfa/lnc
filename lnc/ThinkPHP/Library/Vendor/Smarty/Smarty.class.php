...
class Smarty extends Smarty_Internal_TemplateBase {
    ...
    */
    public function addTemplateDir($template_dir, $key=null)
    {
        ...
        if (is_array($template_dir)) {
            ...
            // override directory at specified Main
    ...
    *
    * @param mixed Main of directory to get, null to get all
    * @return array|string list of template directories, or directory of $Main
    */
